    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            try (Connection conn = Database.getConnection()) {
                ...
                String sql = """
                    INSERT INTO pedidos (id_cliente, id_proveedor, id_empleado, fecha, estado, observaciones)
                    VALUES (?, ?, ?, ?, ?, ?)
                    RETURNING id
                """;
                ...
                if (detalles != null) {
                    ...
                    for (Object o : detalles) {
                        ...
                        double precio_unitario = det.containsKey("precio_unitario")
                                ? ((Number) det.get("precio_unitario")).doubleValue()
                                : 0.0;
                ...
                out.print("{\"error\": \"Error al insertar pedido: " + e.getMessage().replace("\"", "") + "\"}");
            }
